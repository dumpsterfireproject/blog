...
result set. There are 4 kinds of joins. To discuss these, let’s use the customer and address tables from our [sample database](https://thedumpsterfireproject.com/sql-for-the-uninterested).
